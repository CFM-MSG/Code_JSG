...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        # training config
        self.parser.add_argument("--lr", type=float, default=2.5e-4, help="learning rate") # 2.5e-4
    ...
    def parse(self):
        ...
        if isinstance(self, TestOptions):
            ...
            for arg in saved_options:  # use saved options to overwrite all BaseOptions args.
                if arg == 'eval_query_bsz' or arg=='eval_context_bsz' or arg=='npev' or arg=='eval_id': # added
                    continue
                else:
            ...
            opt.results_dir = os.path.join(opt.root_path, opt.collection,
                                           "results/per-video", "-".join([time.strftime("%Y_%m_%d_%H_%M_%S"), 
